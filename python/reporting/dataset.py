...
def build_rows(target: Path, *, use_cache: bool = True, profile: str = "main") -> list[dict[str, Any]]:
    ...
    for run_dir in find_run_dirs(target):
        ...
        row: dict[str, Any] = {
            ...
            "reliability_netem_active": bool(meta.get("reliability_netem_active", False)),
            "reliability_netem_model": meta.get("reliability_netem_model"),
            "reliability_netem_loss_percent": meta.get("reliability_netem_loss_percent", 0),
            "reliability_netem_delay_ms": meta.get("reliability_netem_delay_ms", 0),
            "reliability_netem_jitter_ms": meta.get("reliability_netem_jitter_ms", 0),
            "reliability_netem_rate": meta.get("reliability_netem_rate", ""),
            "reliability_netem_duplicate_percent": meta.get("reliability_netem_duplicate_percent", 0),
            "reliability_netem_reorder_percent": meta.get("reliability_netem_reorder_percent", 0),
            "reliability_netem_corrupt_percent": meta.get("reliability_netem_corrupt_percent", 0),
            "reliability_sensor_attack_type": meta.get("reliability_sensor_attack_type", ""),
            "detector_ovs_dhcp_snooping_enabled": bool(meta.get("detector_ovs_dhcp_snooping_enabled", True)),
            ...
            "detector_max_seen_pps": detector_throughput.get("max_interval_seen_pps"),
            "detector_max_processed_pps": detector_throughput.get("max_interval_processed_pps"),
            "detector_packets_seen": detector_throughput.get("packets_seen"),
            "detector_packets_processed": detector_throughput.get("packets_processed"),
            "zeek_max_seen_pps": zeek_throughput.get("max_interval_seen_pps"),
            "zeek_max_processed_pps": zeek_throughput.get("max_interval_processed_pps"),
            "zeek_packets_seen": zeek_throughput.get("packets_seen"),
            "zeek_packets_processed": zeek_throughput.get("packets_processed"),
            "suricata_max_seen_pps": suricata_throughput.get("max_interval_seen_pps"),
            "suricata_max_processed_pps": suricata_throughput.get("max_interval_processed_pps"),
            "suricata_packets_seen": suricata_throughput.get("packets_seen"),
            "suricata_packets_processed": suricata_throughput.get("packets_processed"),
        }
